...
def getContent(products, productUrls, prices, counts, imgUrls, req):
    ...
    for index in range(0, length):
        productUrls.append(
            "http://mobile.yangkeduo.com/goods.html?goods_id=%d" % product_list[index]["goods_id"])
        ...
        prices.append("常规价: %.2f,开团价格: %.2f " % (product_list[index][
                      "normal_price"] / 100, product_list[index]["group"]["price"] / 100))
